      ...
      <div className="max-w-6xl mx-auto px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {STRENGTHS.map((item, i) => (
            <div
              key={i}
              className="rounded-xl shadow-sm p-8 bg-slate-900/50 border-slate-800 backdrop-blur hover:border-slate-700 transition-all group"
            >
              <div
        ...
        <div className="rounded-xl shadow-sm p-8 bg-slate-900/50 border-slate-800 backdrop-blur mb-8">
        ...
        <div className="grid md:grid-cols-4 gap-4">
          {ACHIEVEMENT_STATS.map((stat) => (
            <div
              key={stat.label}
              className="rounded-xl shadow-sm p-6 bg-slate-900/50 border-slate-800 backdrop-blur text-center"
            >
              <div
